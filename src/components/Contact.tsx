...
const Contact = () => {
  ...
  useGSAP(() => {
    ...
    timeline
      .from(titleSplit.words, { opacity: 0, yPercent: 100, duration: 1, stagger: 0.02 })
    ...
    <footer id="contact">
      ...
      <div className="content">
        ...
        <div>
          ...
          <p><a href="mailto:hello@velvetpour.com">hello@velvetpour.com</a></p>
        </div>
        <div>
        ...
        <div>
          ...
          <form className="contact-form" onSubmit={handleSubmit}>
            ...
            <textarea
              ...
              required
            />
            <button type="submit" className="w-full bg-yellow text-black font-semibold py-3 rounded-xl hover:bg-yellow/90 transition-colors cursor-pointer">
